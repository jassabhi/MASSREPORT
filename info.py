...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7326782027:AAFP7hgYEcCbsdHK1sBSoauUO6JktjBKz6E") # ⚠️ Required
    
    # Other Configs
    BOT_START_TIME = time.time()
    OWNER    = int(os.environ.get("OWNER", "6352107773"))  # ⚠️ Required
...
☛ For e.g :- <code> @ </code> or <code> https://t.me/ll_BAD_BBY_ll </code>
"""
...
Tʜɪs ʙᴏᴛ ɪs sᴏʟᴇʟʏ ᴄʀᴇᴀᴛᴇ ᴏʀ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ :- @ll_BAD_BBY_ll
"""
...
- 𝖢𝗋𝖾𝖺𝗍𝗈𝗋 : <a href=@ll_BAD_BBY_ll</a>
- 𝖫𝗂𝖻𝗋𝖺𝗋𝗒 : Pyrogram
- 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾 : 𝖯𝗒𝗍𝗁𝗈𝗇 𝟥
- 𝖣𝖺𝗍𝖺𝖡𝖺𝗌𝖾 : 𝖬𝗈𝗇𝗀𝗈𝖣𝖡
- 𝖡𝖮𝖳 𝖲𝖾𝗋𝗏𝖾𝗋 : 𝖠𝗇𝗒𝖶𝗁𝖾𝗋𝖾
